...
import { IssuePeriodDetail, ListIssuePeriods } from "pages/IssuePeriod";
...
export default () => <>
    ...
    <main className="dashboard__container">
        ...
        <PrivateRoute exact path="/boards/:boardId(\d+)/lead-time-configs/:leadTimeConfigId(\d+)/edit"
                      component={EditLeadTimeConfig}/>
        ...
        <PrivateRoute exact path="/boards/:boardId(\d+)/issue-periods/:issuePeriodId(\d+)"
                      component={IssuePeriodDetail}/>
